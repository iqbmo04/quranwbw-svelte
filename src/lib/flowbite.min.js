	...
	return (function () {
		...
		var t = {
				...
				902: function (t, e) {
					...
					var n = {
							alwaysOpen: !1,
							activeClasses: 'bg-{window.websiteColors[1].buttonBackgroundHoverColor} dark:bg-{window.websiteColors[1].buttonBackgroundHoverColor} text-{window.websiteColors[1].textMain} dark:text-slate-400',
							inactiveClasses: 'text-{window.websiteColors[1].textMain} dark:text-{window.websiteColors[1].textMain}',
							onOpen: function () {},
							onClose: function () {},
							onToggle: function () {}
						},
				...
				33: function (t, e) {
					...
					var n = {
							...
							indicators: {
								items: [],
								activeClasses: 'bg-{window.websiteColors[1].backgroundMain} dark:bg-{window.websiteColors[1].buttonBackgroundHoverColor}',
								inactiveClasses: 'bg-{window.websiteColors[1].backgroundMain}/50 dark:bg-{window.websiteColors[1].buttonBackgroundHoverColor}/50 hover:bg-{window.websiteColors[1].backgroundMain} dark:hover:bg-{window.websiteColors[1].buttonBackgroundHoverColor}'
							},
							interval: 3e3,
							onNext: function () {},
							onPrev: function () {},
				...
				247: function (t, e) {
					...
					var n = {
							...
							inactiveClasses: 'dark:border-transparent text-{window.websiteColors[1].textMain} hover:text-{window.websiteColors[1].textMain} dark:text-{window.websiteColors[1].textMain} bg-{window.websiteColors[1].hoverBorder} hover:bg-{window.websiteColors[1].hoverBorder} dark:bg-{window.websiteColors[1].hoverBorder} dark:hover:text-{window.websiteColors[1].textMain}',
							onShow: function () {}
						},
						o = (function () {
							function t(t, e) {
