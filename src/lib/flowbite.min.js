	...
	return (function () {
		...
		var t = {
				...
				902: function (t, e) {
					...
					var n = {
							alwaysOpen: !1,
							activeClasses: 'bg-{window.websiteColors[1].buttonBackgroundHoverColor} dark:bg-{window.websiteColors[1].buttonBackgroundHoverColor} text-{window.websiteColors[1].textColorMain} dark:text-slate-400',
							inactiveClasses: 'text-{window.websiteColors[1].textColorMain} dark:text-{window.websiteColors[1].textColorMain}',
							onOpen: function () {},
							onClose: function () {},
							onToggle: function () {}
						},
				...
				33: function (t, e) {
					...
					var n = {
							...
							indicators: {
								items: [],
								activeClasses: 'bg-{window.websiteColors[1].backgroundColorMain} dark:bg-{window.websiteColors[1].buttonBackgroundHoverColor}',
								inactiveClasses: 'bg-{window.websiteColors[1].backgroundColorMain}/50 dark:bg-{window.websiteColors[1].buttonBackgroundHoverColor}/50 hover:bg-{window.websiteColors[1].backgroundColorMain} dark:hover:bg-{window.websiteColors[1].buttonBackgroundHoverColor}'
							},
							interval: 3e3,
							onNext: function () {},
							onPrev: function () {},
				...
				340: function (t, e) {
					...
					var n = { placement: 'left', bodyScrolling: !1, backdrop: !0, edge: !1, edgeOffset: 'bottom-[60px]', backdropClasses: 'bg-{window.websiteColors[1].buttonBackgroundHoverColor} bg-opacity-50 dark:bg-opacity-80 fixed inset-0 z-30 custom-backdrop', onShow: function () {}, onHide: function () {}, onToggle: function () {} },
						o = (function () {
							function t(t, e) {
				...
				16: function (t, e) {
					...
					var n = { placement: 'center', backdropClasses: 'bg-{window.websiteColors[1].buttonBackgroundHoverColor} bg-opacity-50 dark:bg-opacity-80 fixed inset-0 z-40 custom-backdrop', backdrop: 'dynamic', closable: !0, onHide: function () {}, onShow: function () {}, onToggle: function () {} },
						o = (function () {
							function t(t, e) {
				...
				247: function (t, e) {
					...
					var n = {
							...
							inactiveClasses:
								'dark:border-transparent text-{window.websiteColors[1].textColorMain} hover:text-{window.websiteColors[1].textColorMain} dark:text-{window.websiteColors[1].textColorMain} bg-{window.websiteColors[1].hoverBorderColor} hover:bg-{window.websiteColors[1].hoverBorderColor} dark:bg-{window.websiteColors[1].hoverBorderColor} dark:hover:text-{window.websiteColors[1].textColorMain}',
							onShow: function () {}
						},
						o = (function () {
							function t(t, e) {
