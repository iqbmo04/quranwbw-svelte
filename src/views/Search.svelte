...
<div class="theme-grayscale space-y-8">
	...
	<div class="flex max-w-2xl mx-auto">
		<div id="dropdown" class="z-10 bg-{window.websiteColors[1].backgroundMain} divide-y divide-gray-{window.websiteColors[1].textMain} rounded-3xl shadow w-44 dark:bg-{window.websiteColors[1].buttonBackgroundHoverColor}">
			<select
				id="dropdown"
		...
		<div class="flex items-center w-full">
			...
			<button on:click={(event) => (searchText = document.getElementById('search-input').value)} class="p-2.5 text-sm font-medium text-white bg-{window.websiteColors[1].buttonBackgroundHoverColor} rounded-r-3xl border bg-{window.websiteColors[1].hoverBorder} hover:bg-blue-800">
