<svg class="w-3 h-3 text-{window.websiteColors[1].textMain} dark::text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 10 16">
