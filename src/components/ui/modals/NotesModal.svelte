			...
			<div class="px-6 py-6 space-y-8 lg:px-8">
				...
				<div class="">
					<textarea
						...
						rows="8"
						value={verseNote}
						class="block p-2.5 w-full text-sm text-{window.websiteColors[1].textColorMain} bg-{window.websiteColors[1].hoverBackgroundColor} rounded-3xl border bg-{window.websiteColors[1].hoverBorderColor} focus:ring-gray-{window.websiteColors[1].textColorMain} focus:border-blue-500 daaark:bg-{window.websiteColors[1].hoverBackgroundColor} daaark:bg-{window.websiteColors[1]
