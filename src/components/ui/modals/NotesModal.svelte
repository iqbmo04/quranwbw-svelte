			...
			<div class="px-6 py-6 space-y-8 lg:px-8">
				...
				<div class="">
					<textarea
						...
						rows="8"
						value={verseNote}
						class="block p-2.5 w-full text-sm text-{window.websiteColors[1].textMain} bg-{window.websiteColors[1].websitePrimaryNormalrkColor} rounded-3xl border bg-{window.websiteColors[1].hoverBorder} focus:ring-gray-{window.websiteColors[1].textMain} focus:border-blue-500 daaark:bg-{window.websiteColors[1].webwebsitePrimaryNormalolor} daaark:bg-{window.websiteColors[1]
