        ...
        {/if} -->
                ...
                <Email />
						...
						<div class="flex flex-col space-y-4">
							...
							<!-- delete token button -->
							<button id="delete-token" on:click={() => deleteToken()} class="w-full bg-{window.websiteColors[1].buttonBackgroundColor} text-white hover:bg-{window.websiteColors[1].buttonBackgroundHoverColor} {buttonElement}">
