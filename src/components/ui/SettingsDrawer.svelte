...
<div id="settings-drawer" class="fixed top-0 right-0 z-40 h-screen p-4 pt-0 pb-16 overflow-y-auto transition-transform md:rounded-tl-xl md:rounded-bl-xl translate-x-full bg-{window.websiteColors[1].backgroundColorMain} theme-grayscale w-full md:w-1/2 lg:w-[430px] dark:bg-{window.websiteColors[1].buttonBackgroundHoverColor}" tabindex="-1" aria-labelledby="settings-drawer-label">
	...
	<!-- Text Preview -->
	<!-- <div class="z-30 flex flex-col space-y-4 bg-{window.websiteColors[1].backgroundColorMain} border-b-2 pt-2 sticky top-[10%]">
	...
	<div id="display-settings-block" class="py-5">
		<h3 class="block mb-2 font-medium text-xl text-{window.websiteColors[1].textColorMain} dark:text-slate-400">Display</h3>
		...
		<div class="flex flex-col flex-wrap text-base">
			...
			<div id="website-theme-setting" class={settingsBlockClasses}>
				<div class="flex flex-row justify-between items-center">
					<label for="website-theme-list" class="block text-{window.websiteColors[1].textColorMain} dark:text-slate-400">Theme</label>
				...
				<p class="mb-6 text-sm text-{window.websiteColors[1].textColorMain} dark:text-{window.websiteColors[1].textColorMain}">An assortment of website themes to please your vision.</p>
			</div>
			...
			<div id="display-type-setting" class="{settingsBlockClasses} {$__currentPage === 'page' && disabledElement}">
				<div class="flex flex-row justify-between items-center">
					<label for="display-style-list" class="block text-{window.websiteColors[1].textColorMain} dark:text-slate-400">Display Type</label>
				...
				<p class="mb-6 text-sm text-{window.websiteColors[1].textColorMain} dark:text-{window.websiteColors[1].textColorMain}">Different verse layouts that you can choose from.</p>
			</div>
			...
			<div id="word-translation-toggle-setting" class={settingsBlockClasses}>
				<div class="flex flex-row justify-between items-center">
					<span class="block text-{window.websiteColors[1].textColorMain} dark:text-slate-400">Word Translation</span>
				...
				<p class="mb-6 text-sm text-{window.websiteColors[1].textColorMain} dark:text-{window.websiteColors[1].textColorMain}">Toggle the word translation which is shown below the Arabic word.</p>
			</div>
			...
			<div id="word-transliteration-toggle-setting" class={settingsBlockClasses}>
				<div class="flex flex-row justify-between items-center">
					<span class="block text-{window.websiteColors[1].textColorMain} dark:text-slate-400">Word Transliteration</span>
				...
				<p class="mb-6 text-sm text-{window.websiteColors[1].textColorMain} dark:text-{window.websiteColors[1].textColorMain}">Toggle the word transliteration which is shown below the Arabic word.</p>
			</div>
		</div>
	</div>

	<!-- font-settings-block -->
	<div id="font-settings-block" class="py-5 border-t-2 bg-{window.websiteColors[1].hoverBorderColor}">
		<h3 class="block mb-2 font-medium text-xl text-{window.websiteColors[1].textColorMain} dark:text-slate-400">Font</h3>

		<div class="flex flex-col flex-wrap text-base">
			<!-- quran-font-setting -->
			<div id="quran-font-setting" class={settingsBlockClasses}>
				<div class="flex flex-row justify-between items-center">
					<label for="quran-font-list" class="block text-{window.websiteColors[1].textColorMain} dark:text-slate-400">Quran Font</label>
				...
				<p class="mb-6 text-sm text-{window.websiteColors[1].textColorMain} dark:text-{window.websiteColors[1].textColorMain}">Multiple Quranic fonts to choose from depending on your Mushaf or region preference.</p>

				<!-- note for Uthmanic Hafs Mushaf -->
				{#if $__wordType === 2}
					<p class="mb-6 text-sm text-{window.websiteColors[1].textColorMain} dark:text-{window.websiteColors[1].textColorMain}"><b>Note:</b> The Uthmanic Hafs Mushaf font type is still under development and may contain errors and we are aware of them. In case you find any issues, please use a different font type.</p>
				{/if}
			</div>
			...
			<div id="tajweed-toggle-setting" class="{settingsBlockClasses} {$__wordType !== 2 && disabledElement}">
				<div class="flex flex-row justify-between items-center">
					<span class="block text-{window.websiteColors[1].textColorMain} dark:text-slate-400">Colored Fonts</span>
				...
				<p class="mb-6 text-sm text-{window.websiteColors[1].textColorMain} dark:text-{window.websiteColors[1].textColorMain}">Switch between the colored fonts with Tajweed rulings or the normal black & white.</p>
			</div>
			...
			<div id="arabic-word-size-setting" class="{settingsBlockClasses} {$__currentPage === 'page' && disabledElement}">
				<div class="flex flex-row justify-between items-center">
					<span class="block text-{window.websiteColors[1].textColorMain} dark:text-slate-400">Arabic Word Size ({fontSizeCodes.arabicText.split('-')[1]})</span>
				...
				<p class="mb-6 text-sm text-{window.websiteColors[1].textColorMain} dark:text-{window.websiteColors[1].textColorMain}">Font size for Arabic word text.</p>
			</div>
			...
			<div id="word-translation-size-setting" class={settingsBlockClasses}>
				<div class="flex flex-row justify-between items-center">
					<span class="block text-{window.websiteColors[1].textColorMain} dark:text-slate-400">Word Tr/Tl Size ({fontSizeCodes.wordTranslationText.split('-')[1]})</span>
					<div class="inline-flex rounded-md shadow-sm" role="group">
						<button
							type="button"
				...
				<p class="mb-6 text-sm text-{window.websiteColors[1].textColorMain} dark:text-{window.websiteColors[1].textColorMain}">Font size for word translation and transliteration.</p>
			</div>
			...
			<div id="verse-translation-size-setting" class={settingsBlockClasses}>
				<div class="flex flex-row justify-between items-center">
					<span class="block text-{window.websiteColors[1].textColorMain} dark:text-slate-400">Verse Tr/Tl Size ({fontSizeCodes.verseTranslationText.split('-')[1]})</span>
					<div class="inline-flex rounded-md shadow-sm" role="group">
						<button
							type="button"
				...
				<p class="mb-6 text-sm text-{window.websiteColors[1].textColorMain} dark:text-{window.websiteColors[1].textColorMain}">Font size for verse translation and transliteration.</p>
			</div>
		</div>
	</div>

	<!-- translation-settings-block -->
	<div id="translation-settings-block" class="py-5 border-t-2 bg-{window.websiteColors[1].hoverBorderColor}">
		<h3 class="block mb-2 font-medium text-xl text-{window.websiteColors[1].textColorMain} dark:text-slate-400">Translation</h3>

		<div class="flex flex-col flex-wrap text-base">
			<!-- word-translation-setting -->
			<div id="word-translation-setting" class={settingsBlockClasses}>
				<div class="flex flex-row justify-between items-center">
					<label for="word-translations-list" class="block text-{window.websiteColors[1].textColorMain} dark:text-slate-400">Word</label>
				...
				<p class="mb-6 text-sm text-{window.websiteColors[1].textColorMain} dark:text-{window.websiteColors[1].textColorMain}">Word translation which will be displaced under the Arabic word text.</p>
			</div>
			...
			<div id="verse-translation-setting" class={settingsBlockClasses}>
				<div class="flex flex-row justify-between items-center">
					<label for="verse-translations-list" class="block text-{window.websiteColors[1].textColorMain} dark:text-slate-400">Verse</label>
					<button
				...
				<p class="mb-6 text-sm text-{window.websiteColors[1].textColorMain} dark:text-{window.websiteColors[1].textColorMain}">Verse translations from multiple authors and languages.</p>

				<!-- verse-translation dropdown menu -->
				<div id="verse-translation-checkbox" class="z-10 hidden w-fit bg-{window.websiteColors[1].backgroundColorMain} shadow-md rounded-3xl border bg-{window.websiteColors[1].hoverBorderColor}">
					<ul id="verse-translations-list" class="max-h-56 overflow-y-scroll p-3 space-y-4 text-sm text-{window.websiteColors[1].textColorMain} dark:text-{window.websiteColors[1].textColorMain}" aria-labelledby="dropdownCheckboxButton">
	...
	<div id="audio-settings-block" class="py-5 border-t-2 bg-{window.websiteColors[1].hoverBorderColor}">
		<h3 class="block mb-2 font-medium text-xl text-{window.websiteColors[1].textColorMain} dark:text-slate-400">Audio</h3>

		<div class="flex flex-col flex-wrap text-base">
			<!-- verse-reciter-setting -->
			<div id="verse-reciter-setting" class={settingsBlockClasses}>
				<div class="flex flex-row justify-between items-center">
					<label for="reciter-list" class="block text-{window.websiteColors[1].textColorMain} dark:text-slate-400">Verse Reciter</label>
				...
				<p class="mb-6 text-sm text-{window.websiteColors[1].textColorMain} dark:text-{window.websiteColors[1].textColorMain}">Desired reciter whose audio will be played when you choose to listen to a verse.</p>
			</div>
			...
			<div id="playback-speed-setting" class={settingsBlockClasses}>
				<div class="flex flex-row justify-between items-center">
					<label for="speed-list" class="block text-{window.websiteColors[1].textColorMain} dark:text-slate-400">Playback Speed</label>
				...
				<p class="mb-6 text-sm text-{window.websiteColors[1].textColorMain} dark:text-{window.websiteColors[1].textColorMain}">The playback speed at which the verse/word audio will be played.</p>
			</div>
		</div>
	</div>

	<!-- reset settings button -->
	<div class="flex flex-col justify-center border-t bg-{window.websiteColors[1].hoverBorderColor} py-6 space-y-4">
		<button on:click={() => resetSettings()} class="text-sm {buttonElement}">Reset Settings</button>
		<p class="mb-6 text-sm text-{window.websiteColors[1].textColorMain} dark:text-{window.websiteColors[1].textColorMain}">Resetting the options will not affect your bookmarks or last read location.</p>
	</div>
</div>
